...
describe("mortgage lifecycle reliability", () => {
	...
	it("runs a 12-payment mortgage from schedule generation through month-12 maturity with a mid-term ownership transfer and cross-system invariants intact", async () => {
