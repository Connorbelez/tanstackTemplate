...
import { RecordSidebar } from "#/components/demo/crm/RecordSidebar";
							...
							<div className="max-w-3xl space-y-3">
								...
								<div className="space-y-2">
									...
									<p className="max-w-2xl text-muted-foreground text-sm leading-6">
										A vertical CRM demo that stress-tests object metadata,
										record CRUD, view rendering, system adapters, and
										polymorphic links before the admin shell depends on any of
										it.
									</p>
								</div>
							</div>
