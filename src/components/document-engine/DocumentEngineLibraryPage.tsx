...
export function DocumentEngineLibraryPage() {
						...
						<CardContent>
							<div className="space-y-2 text-xs">
								<div className="flex flex-wrap gap-1">
									{pdf.pageDimensions.map((dimension) => (
										<Badge key={dimension.page} variant="outline">
											p{dimension.page + 1}: {Math.round(dimension.width)}x
