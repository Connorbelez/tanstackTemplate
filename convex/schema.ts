...
import {
	...
	entityKindValidator,
	fieldAggregationValidator,
	fieldEditabilityValidator,
	fieldLayoutEligibilityValidator,
...
export default defineSchema({
	...
	fieldDefs: defineTable({
		...
		isVisibleByDefault: v.optional(v.boolean()),
		normalizedFieldKind: v.optional(v.string()),
		rendererHint: v.optional(v.string()),
		editability: v.optional(fieldEditabilityValidator),
		layoutEligibility: v.optional(fieldLayoutEligibilityValidator),
		aggregation: v.optional(fieldAggregationValidator),
		createdAt: v.number(),
		updatedAt: v.number(),
	})
