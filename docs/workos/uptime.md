---
source_url: "https://status.workos.com/uptime"
title: "WorkOS Status - Uptime History"
crawl_depth: 2
---
...
[ Subscribe to UpdatesSubscribe ](https://status.workos.com/uptime)
[ ](https://status.workos.com/uptime#updates-dropdown-email) [ ](https://status.workos.com/uptime#updates-dropdown-sms) [ ](https://status.workos.com/uptime#updates-dropdown-slack) [ ](https://status.workos.com/uptime#updates-dropdown-support) [ ](https://status.workos.com/uptime#updates-dropdown-atom) x 
Get email notifications whenever WorkOS **creates** , **updates** or **resolves** an incident. 
Email address:
Enter OTP:
Resend OTP in: 
Didn't receive the OTP? [Resend OTP ](https://status.workos.com/uptime)
...
Phone number:
[Change number](https://status.workos.com/uptime) Enter OTP:
...
Core Services
[](https://status.workos.com/uptime#back)January 2026 to March 2026[](https://status.workos.com/uptime#forward)
###### January 2026
100%
###### February 2026
100%
