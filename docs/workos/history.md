---
source_url: "https://status.workos.com/history"
title: "WorkOS Status - Incident History"
crawl_depth: 2
---

[![Page logo](https://dka575ofm4ao0.cloudfront.net/pages-transactional_logos/retina/104306/statuspage-pagelogo.png)](https://status.workos.com/)
[ Subscribe to UpdatesSubscribe ](https://status.workos.com/history)
[ ](https://status.workos.com/history#updates-dropdown-email) [ ](https://status.workos.com/history#updates-dropdown-sms) [ ](https://status.workos.com/history#updates-dropdown-slack) [ ](https://status.workos.com/history#updates-dropdown-support) [ ](https://status.workos.com/history#updates-dropdown-atom) x 
Get email notifications whenever WorkOS **creates** , **updates** or **resolves** an incident. 
Email address:
Enter OTP:
Resend OTP in: 
Didn't receive the OTP? [Resend OTP ](https://status.workos.com/history)
By subscribing you agree to our [Privacy Policy](https://workos.com/legal/privacy).
...
Phone number:
[Change number](https://status.workos.com/history) Enter OTP:
Resend OTP in: 30 seconds 
Didn't receive the OTP? [Resend OTP ](https://status.workos.com/history)
Message and data rates may apply. By subscribing you agree to our [Privacy Policy](https://workos.com/legal/privacy), the Atlassian [Terms of Service](https://www.atlassian.com/legal/product-specific-terms#statuspage-specific-terms), and the Atlassian [Privacy Policy](https://www.atlassian.com/legal/privacy-policy). This site is protected by reCAPTCHA and the Google [Privacy Policy](https://policies.google.com/privacy) and [Terms of Service](https://policies.google.com/terms) apply.
Get incident updates and maintenance status messages in Slack. 
[Subscribe via Slack](https://subscriptions.statuspage.io/slack_authentication/kickoff?page_code=87bp477d06pb)
By subscribing you acknowledge our [Privacy Policy](https://workos.com/legal/privacy). In addition, you agree to the Atlassian [Cloud Terms of Service](https://www.atlassian.com/legal/cloud-terms-of-service) and acknowledge Atlassian's [Privacy Policy](https://www.atlassian.com/legal/privacy-policy).
Visit our [support site](https://workos.com/contact). 
Get the [Atom Feed](https://status.workos.com/history.atom) or [RSS Feed](https://status.workos.com/history.rss). 
  * [Incidents](https://status.workos.com/history)
  * [Uptime](https://status.workos.com/uptime)

[](https://status.workos.com/history#back)January 2026 to March 2026[](https://status.workos.com/history#forward)
#### March 2026
No incidents reported for this month.
#### February 2026
[Elevated API Errors](https://status.workos.com/incidents/z5qqjs38v6r1)
All services have returned to normal. This incident is resolved.
Feb 24, 05:11 - 06:16 EST
#### January 2026
[Elevated Error Rates](https://status.workos.com/incidents/d3wplk2jk4rp)
This incident has been resolved.
Jan 27, 13:57 - 14:42 EST
[Degraded Email Delivery to Microsoft Outlook Inboxes](https://status.workos.com/incidents/fnv3vmphcyhs)
...
Jan 22, 18:44 - Jan 23, 10:16 EST
[Delayed Webhook Deliveries](https://status.workos.com/incidents/nsgbwxpwt87g)
Webhook delivery latencies have returned to normal levels. Please contact support if you are still experiencing delays.
Jan 2, 15:48 - Jan 3, 09:20 EST
[ ← Current Status ](https://status.workos.com/) [Powered by Atlassian Statuspage](https://www.atlassian.com/software/statuspage?utm_campaign=status.workos.com&utm_content=SP-notifications&utm_medium=powered-by&utm_source=inapp)
