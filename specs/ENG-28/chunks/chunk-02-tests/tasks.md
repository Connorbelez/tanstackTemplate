...
- [x] T-011: Update existing `convex/ledger/__tests__/ledger.test.ts` — verify no broken references to renamed functions.
- [x] T-012: Run `bunx convex codegen`, `bun check`, `bun typecheck`, `bun run test` — all must pass.
