...
- [ ] T-001: Create `convex/payments/cashLedger/__tests__/e2eHelpers.ts` with `assertObligationConservation(t, { obligationId, postingGroupId })` — asserts settled amount = SUM(dispersal amounts) + servicing fee using BigInt only
