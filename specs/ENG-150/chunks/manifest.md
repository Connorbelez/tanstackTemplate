...
|-------|-------|--------|-------------|
| chunk-01-remaining-queries | T-001 through T-007 | `completed` | Add cashLedgerQuery middleware, date range query, borrower balance, family aggregation, internal variants, quality gate |
